...
public class WebController {
	...
	public String showLoginForm(HttpServletRequest request, Model model) {
	    ...
	    if (session != null) {
	        ...
	        // Remove the error message from the session after retrieving it
	...
	public String dangKy(@ModelAttribute DangKyDTO dangKyDTO, Model model) {
		...
		if (nguoiDungService.findBySDT(dangKyDTO.getDienThoai()) != null) {
			model.addAttribute("error3", "SDT đã tồn tại. Vui lòng nhập tên đăng nhập khác.");
			return "web/dangky/dangky"; // Trả về trang đăng ký với thông báo lỗi
		}
	...
	public String resetPassword(@RequestParam("token") String token, @RequestParam("matKhau") String matKhau,
